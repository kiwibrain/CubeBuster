...
import com.example.resenas.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ReclamoNoEncontradoException.class)
    public ResponseEntity<ErrorResponse> manejarClienteNoEncontrado(ReclamoNoEncontradoException ex,
                                                                    HttpServletRequest request) {
